...
namespace ZFreeGo.TransmissionProtocols.FileSever
{
    ...
    public class FileWriteThransmitAckPacket
    {
        ...
        public UInt32 FileID
        {
            ...
            {
                int offset = 1;
                var num = Helper.ElementTool.CombinationByte(packetData[offset++],
            ...
            {
                int offset = 1;
                packetData[offset++] = Helper.ElementTool.GetBit7_0(value);
                packetData[offset++] = Helper.ElementTool.GetBit15_8(value);
                packetData[offset++] = Helper.ElementTool.GetBit23_16(value);
                packetData[offset++] = Helper.ElementTool.GetBit31_24(value);
            }
        }
        /// <summary>
        /// 数据段号
